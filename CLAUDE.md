...
- After ANY correction from the user: update `.devcontainer/claude/notes.md` with the pattern
...
1. **Plan First**: Write plan to `.devcontainer/claude/todo.md` with checkable items
